...
public class AcceptedRequestFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        final View view = inflater.inflate(R.layout.accepted_request_fragment, container, false);
    ...
    private void Display(final String Email, final String adminName, final String adminImage) {
     ...
     /*   Query query = databaseReference.orderByChild("admin_Email").equalTo(Email);
        query.addChildEventListener(new ChildEventListener() {
            @Override
            public void onChildAdded(@NonNull DataSnapshot dataSnapshot, @Nullable String s) {
                if (dataSnapshot.exists()) {
